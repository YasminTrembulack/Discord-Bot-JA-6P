...
class UserPayload(BaseModel):
    discord_id: str = Field(..., description="ID do usuário (Discord)")
    full_name: str = Field(..., description="Nome global do usuário")
    email: Optional[str] = Field(None, description="Email do usuário")
    # username: Optional[str] = Field(None, description="Nome completo ou de exibição do usuário")
